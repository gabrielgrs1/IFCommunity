    ...
    <body id="body-principal">
            ...
            <header class="avatar">
                ...
                <form name="imageUpload" id="imageUpload">
                    ...
                    <label for="fileUpload">
                        <li class="waves-effect waves-light btn" id="imgChangeButton"><span>Trocar imagem</span></li>
                    </label>
                    <div id="btn-save-cncl" class="row col s12" >
                        <input type="button" id="btnEnviar"/>
                        <label for="btnEnviar">
                            <div class="waves-effect waves-light btn col s6" id="imgSaveButton"><span>Salvar</span></div>
                        </label>
                        <input type="reset" id='resetImg'/>
                        <label for="resetImg">
                            <div class="waves-effect waves-light btn col s6" id="imgCancelButton"><span>Cancelar</span></div>
                        </label>
                    </div>
                </form>
        ...
        <main class="site-content">
                    ...
                    <div class="row">
                        <form class="col s12" id="form-perfil-div">
                            ...
                            <div class="row center-align">
                                <button class="btn btn-large waves-effect waves-light green" id="btn-atualizar-perfil" type="button" name="action">Atualizar<i class="material-icons right">send</i></button>
                        ...
                        <hr id="linha-de-indice-perfil"/>

                        <div class="wrapper1 col s12 col s12">
                            <ul class="collapsible">
                                <li class="recupera-indices-usuario">
                                    <div class="collapsible-header col s12"><div class="col s11"><i class="material-icons">pie_chart_outlined</i><span>Meus índices</span></div><span id="seta-indices" class="material-icons col s1 .seta-indice-antes"></span></div>
                                    <div id="aviso" class="col s12">
                                        <p>A partir de suas atividades serão gerados dados sobre suas contribuições.</p>
                                    </div>
                                    <div class="pie-charts collapsible-body">
                                        <div class="pieID--micro-contribuicoes pie-chart--wrapper1 col s4">
                                            <p>Contribuições</p>
                                            <div class="pie-chart">
                                        ...
                                        <div class="pieID--reputacao pie-chart--wrapper1 col s4">
                                            <p>Reputação</p>
                                            <div class="pie-chart">
                                                <div class="pie-chart__pie"></div>
                                                <ul class="pie-chart__legend">
                                        ...
                                        <div class="pieID--linguagens pie-chart--wrapper1 col s4">
                                            <p>Linguagens</p>
                                            <div class="pie-chart">
                                                <div class="pie-chart__pie"></div>
                                                <ul class="pie-chart__legend">
            ...
            <div id="modal1" class="modal modal-fixed-footer">
                <div class="browser">
                    <div class='btns'>
                        <div class="close modal-action modal-close"></div>
                    </div>
                </div>
                <form id="formDoModal">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/mode-css.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/mode-html.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/mode-java.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/mode-javascript.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/theme-xcode.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/worker-css.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/worker-html.js" type="text/javascript" charset="utf-8"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/ace/1.3.3/worker-javascript.js" type="text/javascript" charset="utf-8"></script>
